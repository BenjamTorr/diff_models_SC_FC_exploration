...
def load_cortical_FC(FC_path = 'data/desikan_fc_all.mat'):
...
def load_cortical_SC(SC_path = 'data/HCP_cortical_DesikanAtlas.mat'):
    #load data from mat format
...
def load_cortical_SC_FC(FC_path = 'data/desikan_fc_all.mat',
    ...
    ids_FC, cortical_FC = load_cortical_FC(FC_path)
    ids_SC, cortical_SC = load_cortical_SC(SC_path)
