...
class MyUNetLatent(nn.Module):
    def __init__(self, n_steps=1000, time_emb_dim=100, dim_space = 128):
        ...
        self.feat1 = nn.Sequential(
            MyBlock((1, dim_space), 1, 10),
            MyBlock((10, dim_space), 10, 10),
            MyBlock((10, dim_space), 10, 10)
        )
        ...
        self.feat2 = nn.Sequential(
            MyBlock((10, dim_space/2), 10, 20),
            MyBlock((20, dim_space/2), 20, 20),
            MyBlock((20, dim_space/2), 20, 20)
        )
        ...
        self.feat3 = nn.Sequential(
            MyBlock((20, dim_space/4), 20, 40),
            MyBlock((40, dim_space/4), 40, 40),
            MyBlock((40, dim_space/4), 40, 40)
        )
        ...
        self.feat_mid = nn.Sequential(
            MyBlock((40, dim_space/8), 40, 20),
            MyBlock((20, dim_space/8), 20, 20),
            MyBlock((20, dim_space/8), 20, 40)
        )
        ...
        self.feat4 = nn.Sequential(
            MyBlock((80, dim_space/4), 80, 40),
            MyBlock((40, dim_space/4), 40, 20),
            MyBlock((20, dim_space/4), 20, 20)
        )
        ...
        self.feat5 = nn.Sequential(
            MyBlock((40, dim_space/2), 40, 20),
            MyBlock((20, dim_space/2), 20, 10),
            MyBlock((10, dim_space/2), 10, 10)
        )
        ...
        self.feat_out = nn.Sequential(
            MyBlock((20, dim_space), 20, 10),
            MyBlock((10, dim_space), 10, 10),
            MyBlock((10, dim_space), 10, 10, normalize=False)
        )
